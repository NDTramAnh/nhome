  ...
  <div class="col-md-10">
    ...
    <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
      ...
      <input type="text" class="form-control"
        value="{{ \Carbon\Carbon::parse($order->import_date)->format('d/m/Y') }}" readonly>
      </div>
    ...
    <div class="d-flex justify-content-between mt-4">
      <a href="{{ route('import.export', $order->id_import) }}" class="btn btn-outline-primary" target="_blank">Xuất
      phiếu</a>
